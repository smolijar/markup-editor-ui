...
Klikání do preview neodscrolluje markup zdroj do správné pozice, což může být nepříjemné obzvláště u delších dokumentů.

==== Porovnání rozdílů

. GitBook je stand-alone produkt - jak desktopová, tak webová verze. Nelze jej tudíž embedovat do jiných stránek.
. Neobsahuje command palette, místo toho má nástrojovou lištu pro vkládání základních markupových konstruktů.
...
Základní UI zobrazuje ve své horní části nástrojové menu, konfiguraci verzí a markdown paletu.
